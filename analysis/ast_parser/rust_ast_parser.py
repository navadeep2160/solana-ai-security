...
def _structural_findings(result, code: str):
    """
    Stub — findings now generated by kb_ast_analyzer.py (KB-driven).
    Kept for backward compatibility — returns empty findings.
    """
    pass  # No hardcoded vulnerability logic here
